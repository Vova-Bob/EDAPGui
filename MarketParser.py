    ...
    def get_market_data(self):
        ...
        while True:
            try:
                ...
                self._log('log.market.read_error', level='warning', error=str(e), resource=self.file_path)
                sleep(backoff)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for item in sorted_list:
            parser._log(
                'log.market.demo.item_status',
                name=item.get('Name_Localised', item.get('Name', '')),
                category=item.get('Category_Localised', ''),
                demand=item.get('DemandBracket', ''),
                stock=item.get('StockBracket', ''),
            )
