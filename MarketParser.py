...
class MarketParser:
    ...
    FALLBACK_MESSAGES = {
        'log.market.read_error': "An error occurred reading {resource} file. File may be open. {error}",
    ...
    def get_market_data(self):
        ...
        while True:
            try:
                ...
                self._log('log.market.read_error', error=str(e), resource=self.file_path)
                sleep(backoff)
