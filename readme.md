...
* Щоб отримати українську озвучку, встановіть [RHVoice для Windows](https://github.com/RHVoice/RHVoice). Після інсталяції з'являться SAPI-голоси (Anatol, Natalia, Volodymyr, Marianna тощо), які pyttsx3 бачить як звичайні системні.
